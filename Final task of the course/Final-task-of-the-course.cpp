...
// нам требуется быстрый поиск событий по дате, а также быстрое удаление конкретного события, используем словарь множеств — map<Date, set<string>>, для каждой даты 
// хранящий множество соответствующих событий.
class Database {
	public:
		Database() {}
